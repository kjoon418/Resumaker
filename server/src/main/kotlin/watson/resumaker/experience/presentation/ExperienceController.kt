...
/**
 * 경험 기록 API: POST/GET/PATCH/DELETE /experiences. 모든 동작은 현재 사용자 소유로 격리된다.
 */
@RestController
...
class ExperienceController(
    ...
    @PostMapping
    fun create(@Valid @RequestBody request: CreateExperienceRequest): ResponseEntity<ExperienceResponse> {
